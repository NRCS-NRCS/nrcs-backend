...
class UserSerializer(serializers.ModelSerializer[User]):
    ...
    class Meta:
        model = User
        fields = ["username", "email", "first_name", "last_name", "password", "user_type", "is_active"]
        extra_kwargs = {
    ...
    def create(self, validated_data: dict[str, typing.Any]) -> User:
        ...
        user = User.objects.create_user(username=username, password=password or "", **validated_data)
