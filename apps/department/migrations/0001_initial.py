    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strategic_directive', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='strategic.strategicdirectives', verbose_name='Strategic Directive')),
            ],
            options={
